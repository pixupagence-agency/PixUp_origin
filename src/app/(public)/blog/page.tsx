        ...
        <main className="flex-grow w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10 py-12 pt-32 transition-colors">
            ...
            <div className="mb-16 text-center max-w-3xl mx-auto">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight text-slate-900 dark:text-white mb-6">
                    {t.blogPage.title} <span className="text-primary italic">{t.blogPage.titleAccent}</span>
                </h1>
            ...
            <section className="mt-24 p-8 md:p-16 rounded-3xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700/50 relative overflow-hidden">
                <div className="relative z-10 max-w-2xl mx-auto text-center">
                    <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">{t.blogPage.newsletter.title}</h2>
                    <p className="text-slate-600 dark:text-slate-400 mb-8">{t.blogPage.newsletter.description}</p>
                    <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                        <input className="flex-1 px-6 py-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-slate-900 dark:text-white" placeholder={t.blogPage.newsletter.placeholder} type="email" />
